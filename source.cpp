...
#define casesx( kind ){   if ((kind) < 15 ) { std::cout << "!!!!!***** "; }\
                    ...
                    else if ((kind) == 71 || (kind) == 79 || (kind) == 80 || (kind) == 82 || (kind) == 83 || (kind) == 84 || (kind) == 88 || (kind) == 91 || (kind) == 95 || (kind) == 100 || (kind) == 102 || (kind) == 103 || (kind) == 104 ) { std::cout << "!!**** "; }\
                    else if ((kind) < 105 ) { std::cout << "!!!!!***** "; }\
