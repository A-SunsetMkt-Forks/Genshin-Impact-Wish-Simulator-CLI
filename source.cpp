...
int main() {
    std::cout << "WELCOME TO GENSHIN IMPACT WISH SIMULATOR CLI V1.6.3" << endl 
    ...
    enter_chosen_banner:
        ...
        while (1) {
            ...
            else if (wishes_number < 0) { wishes_number = 0; std::cout << endl << "Incorrect input!" << endl; goto enter_wishes_number;}
            else {}
