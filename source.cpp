...
int main() {
    ...
    std::cout << endl << "How many wishes? 1: 1 Wish; 10: 10 Wishes" << endl << endl;
    ...
    if (chosen_banner == 1 && chosen_event == 11){
        do {
            ...
            if(temp1 <= 77220){
                ...
                if(temp3 <= 60000) kind = 2;
                else if(temp3 <= 120000) kind = 3;
                else if(temp3 <= 180000) kind = 4;
                else if(temp3 <= 240000) kind = 5;
                else kind = 6;
            }
