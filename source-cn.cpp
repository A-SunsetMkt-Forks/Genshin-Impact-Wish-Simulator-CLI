...
int main() {
    ...
    std::cout << "1: ½ÇÉ«»î¶¯ÆíÔ¸; 2: ÎäÆ÷»î¶¯ÆíÔ¸; 3: ³£×¤ÆíÔ¸; 4: ĞÂÊÖÆíÔ¸" << endl << endl;
    ...
    case 1: {
        std::cout << endl << "Ñ¡Ôñ¿¨³Ø»î¶¯ÀàĞÍ:" << endl
            ...
            << "11: Ôİ±ğ¶¬¶¼/20210406-20210427 (´ï´ïÀûÑÇ, ÂŞÉ¯ÀòÑÇ, °Å°ÅÀ­, ·ÆĞ»¶û)" << endl << endl;
    ...
    case 2: {
        std::cout << endl << "Ñ¡Ôñ¿¨³Ø»î¶¯ÀàĞÍ:" << endl
            ...
            << "10: ÉñÖı¸³ĞÎ/20210406-20210427 (Ìì¿ÕÖ®Òí, ËÄ·çÔ­µä, °µÏïÁÔÊÖ, Î÷·ç½£, ¼ÀÀñ´ó½£, Î÷·çÃØµä, Î÷·ç³¤Ç¹)" << endl << endl;
        std::cin >> chosen_event;
    } break;
    case 3: {
        std::cout << endl << "Ñ¡Ôñ¿¨³Ø»î¶¯ÀàĞÍ:" << endl
            << "1: ±¼ĞĞÊÀ¼ä/20200928-20201222 (¿ª·ş)" << endl
            << "2: ±¼ĞĞÊÀ¼ä/20201223- (ĞÂÔöµÏ°ÂÄÈºÍĞÁìÍ)" << endl << endl;
        std::cin >> chosen_event;
    } break;
