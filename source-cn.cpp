...
int main() {
    std::cout << "Ô­Éñ³é¿¨Ä£ÄâÆ÷£¨ÃüÁîĞĞ£©" << endl << endl;
    while (1) {
        int chosen_banner = 0;
        int chosen_event = 0;
        int wishes_number = 0;
    ...
    enter_chosen_banner:
        ...
        enter_chosen_event_1:
            ...
            if (chosen_event > 0 && chosen_event < 13 && chosen_event == (int)chosen_event) quit = 0; else { std::cout << endl << "ÎŞĞ§»î¶¯ÀàĞÍ!" << endl << endl; goto enter_chosen_event_1; }
        } break;
        case 2: {
        enter_chosen_event_2:
            ...
            std::cout << endl << "Ñ¡Ôñ»î¶¯ÀàĞÍ:" << endl
                ...
                << "8: ÉñÖı¸³ĞÎ/20210223-20210316 (»¤Ä¦Ö®ÕÈ, Ç§ÑÒ¹Å½£, Ç§ÑÒ³¤Ç¹, ÀÇµÄÄ©Â·, ¼ÀÀñ¹­, Á÷ÀËÀÖÕÂ, Ï»ÀïÁúÒ÷)" << endl
                ...
                << "11: ÉñÖı¸³ĞÎ/20210428-20210518 (í½·åÖ®ÈĞ, ³¾ÊÀÖ®Ëø, µÑ½£, Ç§ÑÒ¹Å½£, Ç§ÑÒ³¤Ç¹, ÕÑĞÄ, ¼ÀÀñ¹­)" << endl << endl;
            std::cin >> chosen_event;
            if (chosen_event == -1) { chosen_event = 0; std::cout << endl; goto enter_chosen_banner; }
            if (chosen_event > 0 && chosen_event < 12 && chosen_event == (int)chosen_event) quit = 0; else { std::cout << endl << "ÎŞĞ§»î¶¯ÀàĞÍ!" << endl << endl; goto enter_chosen_event_2; }
        } break;
        case 3: {
        enter_chosen_event_3:
            ...
            std::cin >> chosen_event;
            if (chosen_event == -1) { chosen_event = 0; std::cout << endl; goto enter_chosen_banner; }
            if (chosen_event > 0 && chosen_event < 4 && chosen_event == (int)chosen_event) quit = 0; else { std::cout << endl << "ÎŞĞ§»î¶¯ÀàĞÍ!" << endl << endl; goto enter_chosen_event_3; }
        } break;
        case 4: {
        enter_chosen_event_4:
            ...
            if (chosen_event == -1) { chosen_event = 0; std::cout << endl; goto enter_chosen_banner; }
            if (chosen_event == 1 && chosen_event == (int)chosen_event) quit = 0; else { std::cout << endl << "ÎŞĞ§»î¶¯ÀàĞÍ!" << endl << endl; goto enter_chosen_event_4; }
        ...
        while (wishes_number >= 0) {
            ...
            enter_wishes_number:
            std::cout << endl << "³é¼¸·¢?" << endl << "-1: ÖØĞÂÑ¡Ôñ¿¨³ØÀàĞÍ; 1: 1·¢; 10: 10·¢" << endl << endl;
            ...
            if (wishes_number >= 0) {
                if (five_count == 0) {
                    ...
                    std::cout << endl << "ÄãÒÑ¾­³éÁË " << count << " ·¢¡£" << endl
                        << "ÎåĞÇ½ÇÉ«»òÎäÆ÷:   " << five_count << "  " << five_count * 100.0 / count << "%" << endl
                        << "ËÄĞÇ½ÇÉ«»òÎäÆ÷:   " << four_count << "  " << four_count * 100.0 / count << "%" << endl
                        << "Á¬Ğø·ÇÎåĞÇ×î¸ß¼ÍÂ¼:   " << max_fives << " ·¢¡£·¢ÉúÔÚµÚ " << max_fivesth << " ´Î±£µ×µ¥Ôª¡£¼´ " << max_fivecount + 1 << " ´ÎÆíÔ¸¡£" << endl
                        << "Á¬Ğø·ÇÎåĞÇ×îµÍ¼ÍÂ¼:   " << min_fives << " ·¢¡£·¢ÉúÔÚµÚ " << min_fivesth << " ´Î±£µ×µ¥Ôª¡£¼´ " << min_fivecount + 1 << " ´ÎÆíÔ¸¡£" << endl
